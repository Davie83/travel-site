...
const STATION_NAMES = {
  ...
  '경복궁':     { en: 'Gyeongbokgung',     ja: '景福宮',       zh: '景福宮' }
};
  ...
  for (const l of LOCALES) {
    ...
    writeFile(d + 'index.html', renderPage({
      ...
      body: fill(T.home, {
        ...
        searchGo: escapeHtml(t.searchGo),
        ...
        hl: escapeHtml(code),
        mapTabRegion: escapeHtml(t.mapTabRegion),
        mapTabNearby: escapeHtml(t.mapTabNearby),
...
${tocList}
  ...
  /* 태그 칩은 /?q=<이름> (홈 검색)으로 보냅니다. 이 주소는 홈과 내용이 같은
