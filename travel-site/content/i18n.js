...
module.exports = {
  ...
  ko: {
    ...
    monthRange: (a, b) => `${a} ~ ${b}`,
    nearTitle: '내 주변 맛집 찾기',
    nearHint:  '지금 있는 자리에서 가까운 순으로 보여드려요. 위치는 이 브라우저에서만 쓰고 저장하지 않습니다.',
    ...
    presetStops: n => `${n}곳`,
    routeShelfAll: '전체',
    genreNarrowLabel: '음식 종류로 좁히기',
    areaJumpLabel: '동네로 이동',
    pickShelfTitle: "Davie's Pick",
    pickShelfHint: '지금 가볼 만한 곳',
    orderLabel: '이걸 보여주세요',
    orderHint:  '인원수는 손가락으로 알려주면 됩니다',
    orderSay:   '듣기',
    closedTodayTpl: '오늘은 휴무입니다 ({days})',
    closedCardBadge: '오늘 휴무',
    spicyLabel: '매운맛',
    ...
    tipsTags:  'K-ETA · 교통카드 · 환전 · 1330',
    tipsCta:   '여행 팁 보기',
    tipsNudge: '한국이 처음이라면 — 교통카드·현금·길찾기부터',
    tipsTocHeading: '항목별로 보기',
    tipsAllLabel:   '← 여행 팁 전체 보기',
    regionCount:  n => `전체 ${n}개 지역`,
    popularSearchesLabel: '요즘 많이 찾는',
    statPlaces:      n => `${n}곳`,
    statPlacesLabel: '직접 다녀온 곳',
    statRegions:      n => `${n}개`,
    statRegionsLabel: '전국 지역',
    statLangs:        n => `${n}개`,
    statLangsLabel:   '언어로 제공',
    latest:       '최근 올라온 글',
    more:         '더 보기',
    all:          '전체',
    comingSoon:   '준비 중',
    ...
    mapPanelToggle: n => `동네 지도 보기 (${n})`,
    mapPanelTitle:  '동네 지도',
    mapPanelClose:  '닫기',
    mapPanelNote:   '위치 감각을 보여주는 약식 지도입니다 — 실제 지도가 아닙니다.',
    mapPanelAttrib: '지도 © OpenStreetMap 기여자 ·',
    guideBackSuffix: '전체 글 보기',
    guideBannerLabel: '이 동네 맛집 모음 보기',
  ...
  en: {
    ...
    mapTabRegion: 'By region',
    mapTabNearby: 'Near me',
    pickAll:    'All',
    ...
    faqOrder:  'How do I order in Korean?',
    faqClosed: 'Is there a closing day?',
    ...
    monthRange: (a, b) => `${a}–${b}`,
    nearTitle: 'Find food near me',
    nearHint:  'Shows places nearest to where you are now. Your location stays in this browser and is never stored.',
    ...
    routeShelfAll: 'All',
    genreNarrowLabel: 'Narrow by dish',
    areaJumpLabel: 'Jump to a neighbourhood',
    pickShelfTitle: "Davie's Pick",
    pickShelfHint: 'Where to go right now',
    orderLabel: 'Show this to the staff',
    orderHint:  'Hold up fingers for how many people',
    orderSay:   'Listen',
    closedTodayTpl: 'Closed today ({days})',
    closedCardBadge: 'Closed today',
    spicyLabel: 'Spice',
    ...
    tipsTags:  'K-ETA · Transit card · Exchange · 1330',
    ...
    statPlaces:      n => `${n}`,
    statPlacesLabel: 'places, visited in person',
    statRegions:      n => `${n}`,
    ...
    mapPanelToggle: n => `Show area map (${n})`,
    mapPanelTitle:  'Area map',
    mapPanelClose:  'Close',
    mapPanelNote:   'A rough sketch map for a sense of distance — not an actual map.',
    mapPanelAttrib: 'Map © OpenStreetMap contributors ·',
    guideBackSuffix: 'see all posts',
    guideBannerLabel: 'See our picks for this neighborhood',
  ...
  ja: {
    ...
    monthRange: (a, b) => `${a} ~ ${b}`,
    nearTitle: '近くのお店を探す',
    nearHint:  '今いる場所から近い順に表示します。位置情報はこのブラウザ内だけで使い、保存しません。',
    ...
    presetStops: n => `${n}か所`,
    routeShelfAll: 'すべて',
    genreNarrowLabel: '料理で絞る',
    areaJumpLabel: 'エリアへ移動',
    pickShelfTitle: "Davie's Pick",
    pickShelfHint: 'いま行くならここ',
    orderLabel: '店員に見せてください',
    orderHint:  '人数は指で伝えれば大丈夫です',
    orderSay:   '聞く',
    closedTodayTpl: '本日は定休日です（{days}）',
    closedCardBadge: '本日休み',
    spicyLabel: '辛さ',
    ...
    mapPanelToggle: n => `エリアの地図を見る (${n})`,
    mapPanelTitle:  'エリアの地図',
    mapPanelClose:  '閉じる',
    mapPanelNote:   '距離感をつかむための略図です — 実際の地図ではありません。',
    mapPanelAttrib: '地図 © OpenStreetMap コントリビューター ·',
    guideBackSuffix: 'の記事をすべて見る',
    guideBannerLabel: 'このエリアのおすすめまとめを見る',
  ...
  zh: {
    ...
    monthRange: (a, b) => `${a} ~ ${b}`,
    nearTitle: '找我附近的店',
    nearHint:  '從你現在的位置由近到遠顯示。位置資訊只在這個瀏覽器裡使用，不會儲存。',
    nearBusy:  '正在確認位置…',
    nearDone:  '已按距離排序',
    ...
    tipsTags:  'K-ETA · 交通卡 · 換錢 · 1330',
    tipsCta:   '查看旅遊須知',
    tipsNudge: '第一次來韓國？先看交通卡·現金·找路',
    tipsTocHeading: '按主題瀏覽',
    tipsAllLabel:   '← 返回全部旅遊須知',
    regionCount:  n => `共 ${n} 個地區`,
    popularSearchesLabel: '熱門搜尋',
    statPlaces:      n => `${n}`,
    statPlacesLabel: '親自去過的地方',
    statRegions:      n => `${n}`,
    statRegionsLabel: '個地區',
    statLangs:        n => `${n}`,
    statLangsLabel:   '種語言',
    latest:       '最新文章',
    more:         '查看全部',
    ...
    mapPanelToggle: n => `查看區域地圖 (${n})`,
    mapPanelTitle:  '區域地圖',
    mapPanelClose:  '關閉',
    mapPanelNote:   '這是幫助掌握距離感的示意圖 — 並非實際地圖。',
    mapPanelAttrib: '地圖 © OpenStreetMap 貢獻者 ·',
    guideBackSuffix: '全部文章',
    guideBannerLabel: '看這個街區的精選推薦',
