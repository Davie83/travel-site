...
excerpt: It arrives looking like it will taste strongly of pork offal. It doesn't. Blood sausage cut with chopped nuts, in a broth simmered in a cauldron. Open from 7 in the morning.
tags: [Jeolla, Buan, pisundae, blood sausage, sundae, breakfast, cauldron]
...
That said, tolerance varies. **If you are particularly sensitive to organ meats**, you can order the *sundae-gukbap* — the soup with rice — and skip the sliced blood sausage entirely.

## What makes this version work: the nuts

The detail worth knowing is that this pisundae has **chopped nuts mixed in with the blood.**

You hit them while chewing, and they break up what would otherwise be a heavy, uniform texture. The result reads as **clean** rather than rich — which is not what you expect from a dish that looks like this.
...
> Based on a personal visit and my own tasting. Prices and hours change often, so anything uncertain here is marked **(as of Aug 2026)**.
