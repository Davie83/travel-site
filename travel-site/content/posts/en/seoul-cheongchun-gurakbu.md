---
title: Cheongchun Gurakbu — Grilled Beef Offal in the Mapo Galbi Alley, Teugyang and Daechang
cat: food
region: seoul
area: mapo
date: 2026-09-04
...
excerpt: A grilled beef-offal place in the Mapo galbi alley. Teugyang and daechang are the headliners, but the menu is fairly wide. It's grilled over charcoal, so the taste is solidly above average, and the sides run from raw liver to omasum. Worth it if you like the crisp, crunchy bite of teugyang. The main room is on the loud side.
...
info:
  ...
  - Seating|The main room is fairly **loud** — I couldn't confirm whether there's a private room in the back
...
**Daechang** is one of the mains too. It's filled with fat inside, so grilled it goes crisp outside and rich within. Beyond teugyang and daechang there are several cuts on the menu, which makes it easy to order to a group's taste.

Because it's **grilled over charcoal**, the taste is solidly above average. The sides run to several dishes, led by **raw beef liver and omasum (cheonyeop)**. I finished with a bowl of **mul-naengmyeon** (cold buckwheat noodles in broth) and left full — the noodles weren't special, but they were decent enough.
...
- Staff usually sear or grill it for you. You don't need to know how to grill.
- The sides include **raw beef liver and omasum (cheonyeop)** — a traditional Korean accompaniment. If raw liver isn't for you, just leave it.
...
- ✅ Anyone after charcoal-scented grilled offal
- ✅ A group that wants to pick **several different cuts**
- ⚠️ Anyone wanting a quiet room — the main room is loud (private room unconfirmed)
- ⚠️ Anyone put off by the texture or fat of offal

## Before you go

- **Location** — the Mapo galbi alley, Mapo-gu, Seoul. Several grill houses share the alley, so check the shop name on the map before you go.
