---
title: Seochon Gyedanjip — a seasonal-seafood spot worth the trip on the coldest days
cat: food
region: seoul
area: gwanghwamun
date: 2026-09-15
...
excerpt: A seasonal-seafood spot tucked in a Seochon alley. Seafood lovers tend to already know this one. It serves unique seasonal catches you won't find at an ordinary seafood place, at a price that runs a bit higher. The seafood ramyeon everyone seems to order is famous too.
tags: [Seoul, Jongno, Seochon, Jahamun-ro, Gyeongbokgung, seafood, crab, whelk, seafood ramyeon]
map: https://www.google.com/maps/search/?api=1&query=%EC%84%9C%EC%B4%8C%EA%B3%84%EB%8B%A8%EC%A7%91
info:
  - Restaurant|Seochon Gyedanjip
...
We ordered the whelk (cham-sora), served with carrot and onion — great chewy texture.

Crab was also in season this visit, so a big steamed crab came out alongside it — the shell packed with meat and roe.
...
- The menu shifts with whatever comes in that day. If crab, whelk, or another seasonal item is available, it's worth asking about and ordering.
- The **seafood ramyeon** is considered close to a must-order among visitors.
- **No reservations** — it's walk-in only. Turnover is decent, but expect to wait.
- About a **3-minute walk** from Gyeongbokgung Station (Line 3).

## Good for you if

- ✅ You want seasonal seafood, including items that aren't common elsewhere
- ✅ You're exploring Seochon's alleys and want dinner nearby
- ✅ You prioritize freshness and rarity over price
- ⚠️ You're hoping for a cheap meal — prices run a bit higher here
- ⚠️ You want to book ahead — this place is walk-in only
