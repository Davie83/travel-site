...
excerpt: Raw blue crab cured in soy sauce, not over-salted, served as a full set meal with grilled fish, steamed egg, crab stew and a dozen side dishes. The set is the strength here, not the crab meat itself. Reservation essentially required.
tags: [Seoul, Mapo, ganjang gejang, raw crab, set meal, reservation required, Korean set menu]
...
Two things, and they matter more than anything else in this article.
...
Being honest: **the strength here is the whole table, not the crab.**

![The full set — soy-marinated crab with grilled croaker, steamed egg, spicy crab stew, greens and pancakes](/assets/img/seoul-seosan-kkotge-table.jpg)

What's in the photo:

- **Ganjang gejang** — the soy-marinated crab, centre
- **Grilled croaker** (a small whole fish)
- **Steamed egg** — soft, savoury, served in a hot pot
- **Spicy crab stew**
...
## About the crab itself

**It isn't over-salted.** Many places cure gejang aggressively salty; this one is balanced, and that's a genuine plus.

But **the amount of crab meat is smaller than at the better-known houses nearby.** Mapo and Ahyeon have a cluster of famous gejang restaurants, and on crab meat alone this one doesn't lead.

So, plainly:

- **Coming for crab meat above all** — you may leave a little disappointed
- **Coming for a Korean set meal where crab is the centrepiece** — you'll be happy

At **₩40,000 a head**, the second framing is the fair one, and by that measure the table is good value.

## How to eat it

There is a technique, and it's worth knowing.

1. **Pick up the legs and suck the meat out.** Digging with chopsticks wastes your time
2. **Put rice inside the body shell**, then mix it with the roe and the soy marinade. **This is the point of the dish** — Koreans call gejang a *bapdoduk*, a "rice thief," for exactly this reason
3. **Your hands will get messy.** Ask for wet wipes at the start
...
- ✅ You want a full Korean set-meal spread, not a single dish
- ✅ You'd rather have balanced seasoning than heavy salt
- ✅ You're fine booking ahead and arriving on time
- ⚠️ **The crab is raw and uncooked**
