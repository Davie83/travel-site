...
info:
  ...
  - 구글 평점|3.9 (리뷰 852개)
  - 대기|(2026.08 기준) — 리뷰에서 가장 많이 언급되는 것 중 하나입니다
---
...
그래서 시간이 걸리는 게 이 집이 느려서가 아니라 **이 디저트의 원리 자체**입니다. 뒤에 나오는 리뷰 데이터에도 이게 그대로 드러납니다.
...
- **저녁까지 이어간다면** — 걸어서 갈 수 있는 을지로 갈비골목의 [시골집](/posts/seoul-sigoljip)에서 LA갈비로 마무리하는 코스도 있습니다.
