...
info:
  ...
  - 짬뽕·군만두 값|**짬뽕 11,000원 · 군만두 9,500원** (다이닝코드 기준, 변동 가능)
...
**밤 9시 30분에 문을 닫습니다.** 늦은 저녁이면 시간을 보고 가세요. 문 여는 시간과 휴무일은 확인이 필요합니다. 짬뽕 말고 회가 당기는 날이면, 같은 영등포에 있는 [도림항 영등포점](/posts/seoul-dorimhang)도 도보로 갈 만한 거리입니다. 매운 짬뽕 말고 꼬리수육이 당기는 날이면, [대한옥](/posts/seoul-daehanok-sokkorijjim)도 걸어서 갈 만합니다.
...
짬뽕은 11,000원, 군만두는 9,500원입니다(다이닝코드 기준). 값은 계속 바뀔 수 있으니 가서 한 번 더 확인하시면 좋습니다.
