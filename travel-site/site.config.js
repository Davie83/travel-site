...
module.exports = {
  ...
  locales: [
    ...
    { code: 'ja', dir: 'ja/', label: '日本語',  short: 'JA', htmlLang: 'ja',      hreflang: 'ja',      enabled: false },
    { code: 'zh', dir: 'zh/', label: '简体中文', short: '中', htmlLang: 'zh-Hans', hreflang: 'zh-Hans', enabled: false }
  ],
