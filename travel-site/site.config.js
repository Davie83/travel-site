  ...
  regions: [
    { slug: 'seoul',       color: '#312a7e', colorDark: '#827adc',   // 남색
      ...
      intro: {
        ...
        ja: 'ソウルはこのサイトで最も記録が多い地域で、下の店や見どころはすべて実際に足を運んだ場所を地区別にまとめたものです。地区ごとに食べる色が違います — **汝矣島**は会社員のランチ（コムタン・コングクス・フォー）と国会前の漢江ビューのカフェ、**明洞・南大門**は市場の冷麺や老舗カルグクス・太刀魚の煮付けに南山のビビンバ、**乙支路・鍾路**はスンデクッパやLAカルビの老舗と益善洞の韓屋デザート、**麻浦**は麻浦駅の焼肉・ホルモンと洋館を改装したカフェ、**弘大**は夜遅くまでやっているラーメンとカフェ、**永登浦**は文来の路地と永登浦駅の老舗、**江南・瑞草**は駅三駅・テヘラン路のドリップコーヒーやハンバーガー、プデチゲ、**梨泰院・漢南**は韓牛コース、**光化門・西大門**は老舗の鶏コムタンと西村の旬の海鮮です。\n多くは地下鉄で行けて徒歩10分以内なので、1日に2〜3か所まとめやすいです。下の地区ボタンで絞るか、気に入った場所を保存して順番に並べれば動線ができます — 保存ページにはソウルのおすすめコースもあります。',
        zh: '首爾是本站記錄最多的地區，下面的餐廳和景點都是我們親自去過的地方，按街區整理。每個街區吃的味道都不同 —— **汝矣島**是上班族午餐（牛肉湯、豆漿麵、河粉）加國會前的漢江景觀咖啡館；**明洞·南大門**是市場冷麵、老字號刀切麵和燉白帶魚，還有南山的拌飯；**乙支路·鍾路**是血腸湯、LA排骨的老店加益善洞的韓屋甜點；**麻浦**是麻浦站的烤肉、牛腸和老洋房改的咖啡館；**弘大**是營業到深夜的拉麵和咖啡館；**永登浦**是文來的巷子和永登浦站的老店；**江南·瑞草**是驛三站德黑蘭路一帶的手沖咖啡、漢堡和部隊鍋；**梨泰院·漢南**是韓牛套餐；**光化門·西大門**是老店雞肉湯和西村的當季海鮮。\n大多搭地鐵到得了、步行十分鐘內，一天排兩三處剛好。用下面的街區按鈕篩選，或把喜歡的地方存起來、排好順序就成了動線 —— 「已存」頁面也有現成的首爾推薦路線。' },
      areas: [
        ...
        { slug: 'myeongdong',   names: { ko: '명동·남대문', en: 'Myeongdong & Namdaemun', ja: '明洞・南大門',  zh: '明洞·南大門' },
          ...
          seoTitle: {
            ...
            zh: '南大門市場老店美食 — 明洞·南大門' },
          intro: {
            ko: '명동·남대문은 남대문시장 노포와 명동·남산 관광 동선이 겹치는 곳으로, 냉면·칼국수·갈치조림·비빔밥이 모여 있습니다. 남대문시장 안에는 부원면옥(2층 냉면·만둣국), 우정식당(백반), 호남식당(갈치조림 골목), 막내횟집(평일 점심 한정 회정식)이 있고, 명동 쪽에는 명동교자 칼국수와 남산 자락 목멱산방 나물 비빔밥, 24시간 여는 신동궁 뼈숯불구이가 있습니다. 오사카식 오코노미야끼 쯔루하시 후게츠, 한국 재료로 만든 양식 심퍼티쿠시, 한국은행 옆 테일러커피까지 묶으면 하루가 알찹니다. 시장 골목은 처음엔 찾기 어려우니 지도에서 상호를 확인하고 들어가세요.',
            en: 'Myeongdong & Namdaemun is where Namdaemun Market veterans overlap with the Myeongdong–Namsan tourist route — naengmyeon, kalguksu, braised hairtail and bibimbap. Inside the market are Buwon Myeonok (second-floor naengmyeon and dumpling soup), Ujeong Sikdang (home-style set meals), Honam Sikdang in the braised-hairtail alley, and Maknae Hoejip (a sashimi set served only at weekday lunch); over in Myeongdong there is Myeongdong Gyoja for kalguksu, Mongmyeoksanbang for mild namul bibimbap on the slope of Namsan, and Sindonggung, a 24-hour grilled-pork-bones spot. Round the day out with Osaka-style okonomiyaki at Tsuruhashi Fugetsu, Korean-ingredient Western food at Szimpatikus, or coffee at Tailor Coffee by the Bank of Korea. The market alleys are hard to find the first time — check the name on the map before you go in.',
            ja: '明洞・南大門は南大門市場の老舗と明洞・南山の観光動線が重なる場所で、冷麺・カルグクス・太刀魚の煮付け・ビビンバが集まっています。市場の中にはプウォンミョノク（2階の冷麺・餃子スープ）、ウジョンシクタン（ペクバン）、太刀魚の煮付け横丁のホナムシクタン、平日ランチだけのマンネフェッチプ（刺身定食）があり、明洞側には明洞餃子のカルグクス、南山のふもとのモンミョクサンバンの薄味のナムルビビンバ、24時間営業のシンドングンのポークリブ炭火焼きがあります。大阪風お好み焼きの鶴橋風月、韓国食材の洋食シンポティクシ、韓国銀行のそばのテイラーコーヒーまで組み合わせれば一日が充実します。市場の路地は最初は見つけにくいので、地図で店名を確認してから入ってください。',
            zh: '明洞·南大門是南大門市場老店和明洞、南山觀光動線重疊的地方，聚集了冷麵、刀切麵、燉白帶魚和拌飯。市場裡有富元麵屋（二樓的冷麵、餃子湯）、友情食堂（家常定食）、燉白帶魚巷的湖南食堂，還有只在平日午餐供應的老么生魚片家（生魚片定食）；明洞這側有明洞餃子的刀切麵，南山山腳下明洞山房清淡的野菜拌飯，以及24小時營業的新東宮炭烤豬脊骨。再加上大阪風御好燒鶴橋風月、用韓國食材做的西餐 SZIMPATIKUS、韓國銀行旁的 Tailor Coffee，安排一整天很充實。市場巷子第一次不好找，進去前先在地圖上確認店名。' } },
